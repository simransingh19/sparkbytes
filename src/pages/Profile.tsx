      ...
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        <Card>
          <Card style={{ margin: '2vw' }}>
            ...
            <Button onClick={signInWithGoogle}>Login with your BU Gmail</Button>
          </Card>
          <Card style={{ margin: '2vw' }}>
            <Paragraph>First time here?</Paragraph>
            <Button onClick={signInWithGoogle}>Sign Up with your BU Gmail</Button>
          </Card>
        </Card>
      </div>
    );
