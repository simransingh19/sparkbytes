...
import { Card, Form, Input, Button, Select, DatePicker, Typography, Upload } from 'antd';
    ...
    return (
        <div style={{padding: "10vh"}}>
            <Card style={{margin: '20px auto', width: '30vw'}}>
                ...
                <Form layout="vertical" form={form} onFinish={handleSubmit} style={{paddingLeft: '2vw', paddingRight: '2vw'}}>
